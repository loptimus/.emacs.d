  ...
  `(("Rename Variable Name" erl-refactor-rename-var)
    ...
    ("Refactorings for QuickCheck"  
     (
      ...
      ("Rename an operation argument" erl-refactor-rename-op-arg)
      ("Add an operation argument" erl-refactor-add-op-arg)
      ("Remove an operation argument" erl-refactor-remove-op-arg)  
      ("Add an operation" erl-refactor-add-op)       
      ("Remove an operation" erl-refactor-remove-op) 
      ("Re-order operation parameters" erl-refactor-swap-op-args)           
      ))
    nil
...
(defun wrangler-erlang()
  ...
  (setq opts (list "-name" wrangler-erl-node-string
                   "-pa" (expand-file-name (concat "D:/Program Files/Wrangler" "/ebin"))
...
(defun erl-refactor-version()
  (interactive)
  (message "Wrangler version 1.1")) 

(setq wrangler-version  "(wrangler-1.1) ")
