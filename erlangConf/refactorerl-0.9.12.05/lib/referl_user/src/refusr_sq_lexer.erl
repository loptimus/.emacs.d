...
-module(refusr_sq_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 48).
...
-file("./lib/referl_user/src/refusr_sq_lexer.erl", 283).
yystate() -> 20.
...
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 98, C =< 110 ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
yystate(20, [C|Ics], Line, Tlen, Action, Alen) when C >= 112, C =< 122 ->
    yystate(21, Ics, Line, Tlen+1, Action, Alen);
...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 35 ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
...
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 9).
yyaction_0(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 12).
yyaction_1(TokenLine) ->
     { token, { 'and', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 15).
yyaction_2(TokenLine) ->
     { token, { 'or', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 18).
yyaction_3(TokenLine) ->
     { token, { comparator, TokenLine, '==' } } .

-compile({inline,yyaction_4/2}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 21).
yyaction_4(TokenChars, TokenLine) ->
...
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 27).
yyaction_5(TokenChars, TokenLen, TokenLine) ->
...
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 34).
yyaction_6(TokenChars, TokenLen, TokenLine) ->
     String = lists : sublist (TokenChars, 2, TokenLen - 2),
     { token, { string, TokenLine, String } } .

-compile({inline,yyaction_7/2}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 38).
yyaction_7(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_8/2}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 41).
yyaction_8(TokenChars, TokenLine) ->
     { token, { comparator, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_9/0}).
-file("./lib/referl_user/src/refusr_sq_lexer.xrl", 44).
yyaction_9() ->
     skip_token .
