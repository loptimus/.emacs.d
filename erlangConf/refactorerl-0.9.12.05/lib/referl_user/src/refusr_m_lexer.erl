...
-module(refusr_m_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 28).
...
-file("./lib/referl_user/src/refusr_m_lexer.erl", 278).
yystate() -> 37.

yystate(68, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
...
yystate(67, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line,67};
yystate(66, [118|Ics], Line, Tlen, _, _) ->
...
yystate(66, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(66, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 117 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(66, [C|Ics], Line, Tlen, _, _) when C >= 119, C =< 122 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(54, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(54, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 108 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(54, [C|Ics], Line, Tlen, _, _) when C >= 110, C =< 122 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(53, [10|Ics], Line, Tlen, _, _) ->
    yystate(53, Ics, Line+1, Tlen+1, 13, Tlen);
yystate(53, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(53, Ics, Line, Tlen+1, 13, Tlen);
yystate(53, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(53, Ics, Line, Tlen+1, 13, Tlen);
...
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 103 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(51, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 116 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 119 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(37, [109|Ics], Line, Tlen, Action, Alen) ->
...
yystate(37, [101|Ics], Line, Tlen, Action, Alen) ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [99|Ics], Line, Tlen, Action, Alen) ->
...
yystate(37, [44|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [40|Ics], Line, Tlen, Action, Alen) ->
    yystate(44, Ics, Line, Tlen+1, Action, Alen);
...
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(53, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 103, C =< 108 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 110, C =< 114 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(37, [C|Ics], Line, Tlen, Action, Alen) when C >= 117, C =< 122 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
...
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 104 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 108 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 112, C =< 116 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 100 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 102, C =< 104 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(25, [C|Ics], Line, Tlen, _, _) when C >= 106, C =< 110 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 119 ->
    yystate(19, Ics, Line, Tlen+1, 10, Tlen);
...
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { show, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 8).
yyaction_1(TokenChars, TokenLine) ->
     { token, { for, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 9).
yyaction_2(TokenChars, TokenLine) ->
     { token, { save, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 10).
yyaction_3(TokenChars, TokenLine) ->
     { token, { compare, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 11).
yyaction_4(TokenChars, TokenLine) ->
     { token, { module, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 12).
yyaction_5(TokenChars, TokenLine) ->
     { token, { function, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 14).
yyaction_6(TokenChars, TokenLine) ->
     { token, { metrics, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_7/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 16).
yyaction_7(TokenChars, TokenLine) ->
     { token, { filters, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_8/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 18).
yyaction_8(TokenChars, TokenLine) ->
     { token, { fil, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_9/3}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 19).
yyaction_9(TokenChars, TokenLen, TokenLine) ->
     S = strip (TokenChars, TokenLen),
     { token, { string, TokenLine, S } } .

-compile({inline,yyaction_10/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 21).
yyaction_10(TokenChars, TokenLine) ->
     { token, { func, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_11/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 22).
yyaction_11(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_12/2}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 23).
yyaction_12(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_13/0}).
-file("./lib/referl_user/src/refusr_m_lexer.xrl", 24).
yyaction_13() ->
     skip_token .
