{application,yaws,
 [{description,"yaws WWW server"},
  {vsn, "1.92"},
  {modules,[yaws, yaws_app, yaws_ticker, yaws_config, yaws_server, yaws_sup, yaws_api, yaws_log, yaws_trace, yaws_logger, yaws_ls, yaws_debug, yaws_compile, yaws_ctl, yaws_cgi, yaws_zlib, yaws_generated, mime_types, yaws_session_server, yaws_outmod, yaws_revproxy, yaws_html, yaws_log_file_h, yaws_rss, yaws_dav, yaws_pam, json, json2, jsonrpc, yaws_jsonrpc, yaws_xmlrpc, haxe, yaws_rpc, yaws_soap_srv, yaws_soap_lib, authmod_gssapi, yaws_appmod_cgi, yaws_appmod_fcgi, yaws_sendfile, yaws_sup_restarts, yaws_stats, yaws_vdir, yaws_multipart, yaws_shaper, yaws_dime, yaws_exhtml, yaws_websockets]},
  {registered, []},
  {mod,{yaws_app,[]}},
  {env, [
